...
struct BlockChain {
      ...
      static void deleteBlockChain(const BlockChain* head);
};
...
/**
 * TimesTwo - Returns a recived integer value multiplied by two
 *
 * @param value An integer value to be multiplied
*/
unsigned int TimesTwo(unsigned int value);
